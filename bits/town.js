let supercollidersDesiredCount = 20
let monumentDesiredCount = 10
let stockExchangeDesiredCount = 1
let railwayDesiredCount = 0

let factoryLimit = -1
let fissionLimit = -1
let fuelDepotLimit = 5
let containerPortLimit = 15
let freightYardLimit = 20
